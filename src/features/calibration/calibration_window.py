...
class CameraCalibrationWindow(FramelessMainWindow, CalibrationMenuMixin):
    ...
    Actúa como contenedor para el CalibrationController.
    """
    def __init__(self):
        super().__init__()
    ...
    def __setup_base_ui(self):
        """ Configura los contenedores principales de la ventana frameless """
    ...
    def __setup_services(self):
        """ Inicializa servicios de tema y monitoreo de hardware """
    ...
    def __setup_connections(self):
        """ Configura las conexiones de eventos de la ventana """
    ...
    def closeEvent(self, event):
        """ Asegura la limpieza de recursos al cerrar la ventana """
