...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QMenu, QFileDialog,
                             QMessageBox, QDialog, QHBoxLayout, QLabel, QSpinBox, QPushButton)
from PyQt6.QtCore import Qt, pyqtSignal


class TimeAxisItem(pg.AxisItem):
    """
    Clase para el eje X que transforma puntos a segundos y los muestra como positivos.
    """
...
class PlotCursor:
    """
    Cursor personalizado para realizar mediciones sobre las gráficas.
    """
...
class PlotWidget(pg.PlotWidget):
    ...
    Encapsula toda la lógica visual de pyqtgraph.
    """
    ...
    def __setup_ui(self):
        ...
        self.plot_item.setMenuEnabled(False)  # Deshabilitar menú nativo
    ...
    def wheelEvent(self, ev):
        """ Ignorar zoom con la rueda del mouse """
        ev.ignore()
