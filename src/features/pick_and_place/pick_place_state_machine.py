...
class PickPlaceStateMachine(StateMachine):
    ...
    ready_to_place = waiting_for_input.to(place_approach)
    ...
    retract_lift_done = retract_lift.to(retract_to_pid_home)
    
    retract_done = retract_to_pid_home.to(waiting_for_input)
