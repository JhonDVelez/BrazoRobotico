...
QWidget {
    ...
    selection-background-color: #1482FA;
...
#title_bar {
    background-color: #0c0e12; border-radius: 0px
}
#buttons_frame {
    background-color: {#0c0e12; border-radius: 0px;}
...
#title_bar {
    background-color: #0c0e12; color: #ffffff;
}
QStatusBar {
    background-color: #0c0e12;  
    border-top: 1px groove #1E1E21
}
QStatusBar::item {
    border: none;
}
...
QCheckBox:hover,
QRadioButton:hover {
    border-bottom: 2px solid #1A70E6;
}
QCheckBox::indicator,
...
#modelBox, #cameraBox, #graphsBox, #controlsBox, #radio_button_container, #angular_container, #cartesian_container, #graph_stack_container, #graph_widget{
    margin: 0px;
    padding: 0px;
    background-color: #191B20;
}
#modelBox QLabel, #cameraBox QLabel, #graphsBox QLabel, #sliders_widget QWidget, #kinematics_widget QWidget {
    background-color: #191B20;
}
#controlsBox > QWidget, #controls_holder, #controls_holder > QWidget, #kinematics_holder, #plot_widget, #sliders_widget, #sliders_container {
    border: none;
    margin: 0px;
    padding: 0px;
    background-color: #191B20;
}
#controls_holder QSlider{
    background-color: #191B20;
}
...
QToolButton:checked {
    background-color: rgba(140.000, 28.000, 28.000, 1.000);
}
...
QTabBar::tab:hover {
    background-color: rgba(18.000, 80.000, 123.000, 1.000);
}
...
#closeBtn {
    qproperty-icon: url(src/resources/icons/close_d.svg);
    padding: 0px;
}
#undockBtn {
    qproperty-icon: url(src/resources/icons/restore_down_d.png);
    padding: 0px;
}
#undockBtn:hover, #closeBtn:hover, #send_kinematics:hover { 
    background-color: #44464a;
}
#undockBtn:pressed, #closeBtn:pressed, #send_kinematics:pressed { 
    background-color: #0a0b0e;
}
