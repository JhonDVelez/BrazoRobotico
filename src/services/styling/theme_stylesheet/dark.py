...
para el modo oscuro, con colores base #121417 y acentos #1A70E6.
...
#title_bar {
    background-color: #121417; border-radius: 0px
}
#buttons_frame {
    background-color: {#121417; border-radius: 0px;}
...
#title_bar {
    background-color: #121417; color: #ffffff;
}
QStatusBar {
    background-color: #121417;  
