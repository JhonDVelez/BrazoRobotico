...
QWidget {
    ...
    selection-background-color: #2378D5;
    selection-color: #F7F7FA;
}
QWidget:disabled {
...
#title_bar {
    background-color: #F7F7FA; border-radius: 0px
}
#buttons_frame {
    background-color: {#F7F7FA; border-radius: 0px;}
